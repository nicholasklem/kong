...
local schemas_topological_sort do
  ...
  local function sort_core_first(a, b)
  ...
  schemas_topological_sort = function(schemas)
    local s
...
function declarative.load_into_db(entities, meta)
  ...
  local sorted_schemas, err = schemas_topological_sort(schemas)
...
declarative._schemas_topological_sort = schemas_topological_sort
